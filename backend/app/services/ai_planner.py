...
class AIPlanner:
    ...
    def generate_channel_strategy(
        ...
        prompt = f"""
あなたはYouTubeチャンネル戦略の専門家です。以下のペルソナ情報に基づいて、成功するチャンネル戦略を提案してください。
...
## 指示
以下のJSON形式で、戦略的なチャンネル企画案を作成してください：

{{
  "channel_concept": "チャンネルの核となるコンセプト（1-2文）",
  "unique_value": "他のチャンネルとの差別化ポイント",
  "target_audience": "ターゲット視聴者の具体的な描写",
  "content_pillars": ["柱1", "柱2", "柱3", "柱4"],
  "posting_frequency": "推奨投稿頻度と理由",
  "growth_strategy": ["戦略1", "戦略2", "戦略3", "戦略4", "戦略5"],
  "video_concepts": [
    {{
